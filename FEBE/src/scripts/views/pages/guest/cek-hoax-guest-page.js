...
import AddGuestStoryPresenter from '../../../presenters/guest/add-guest-story-presenter';
...
export default class AddGuestStoryPage {
  constructor() {
    ...
    this.presenter = new AddGuestStoryPresenter(this);
  }
        ...
        <div class="container">
          <section class="add-story">
            <form id="guest-story-form" class="story-form">
              ...
              <p class="guest-note"><i class="fas fa-info-circle"></i> Sebagai tamu, Anda hanya dapat melakukan verifikasi berita sebanyak tiga kali.</p>
